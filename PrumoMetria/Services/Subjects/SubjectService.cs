...
public class SubjectService : ISubjectService
{
    ...
    public async Task<ServiceResult<SubjectDTO>> Update(string userId, Guid studyPlanId, UpdateSubjectDTO id)
    {
    ...
    public async Task<ServiceResult<SubjectDTO?>> GetSubjectById(string userId, Guid studyPlanId)
    {
        throw new NotImplementedException();
    }

    public async Task<ServiceResult<List<SubjectDTO>>> GetSubjectsByUserId(string userId)
    {
        throw new NotImplementedException();
    }
}